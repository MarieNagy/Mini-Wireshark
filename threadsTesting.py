...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButtonStart.clicked.connect(worker.start)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionStart.triggered.connect(worker.start)
    ...
    def filter_choice(self):
        ...
        self.filterDisplay(self.comboBoxFilter.currentText())

    def filterDisplay(self, p):
        filteredList = []
        if(stopFlag==True):
            for p in pktsList:
                if p.haslayer(p):
